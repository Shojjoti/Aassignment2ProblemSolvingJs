...
একটি Number array, যেখানে প্রতিটি সংখ্যা একজন মানুষের ওজন (কেজি), যেমনঃ
...
- `true` যদি মোট ওজন ৪০০ কেজি বা তার কম হয় (চলা নিরাপদ)
- `false` যদি ৪০০ কেজির বেশি হয় (ওভারলোড)
...
- প্রথম ৫০০ token ফ্রি।
- এরপর প্রতি অতিরিক্ত ১০০ token এর জন্য ৫ টাকা চার্জ হবে।
...
একটি Number array, যেখানে প্রতিটি সংখ্যা একটি request-এর response time (ms), যেমনঃ
...
এখানে **৬টি আলাদা bug** আছে — খেয়াল করে দেখো:

- array চেক কীভাবে লেখা হয়েছে
- empty-array চেক কীভাবে লেখা হয়েছে
- loop কোথা থেকে শুরু হচ্ছে
- loop কোথায় শেষ হচ্ছে
- loop-এর ভেতরে ব্যবহৃত variable-এর নাম
- শেষে কী দিয়ে ভাগ করা হচ্ছে
